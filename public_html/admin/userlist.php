                                        ...
                                        <td><?php echo $row['email'];?></td>
                                         <td><?php echo $row['mobile'];?></td>
                                          <td><?php echo $row['address'];?></td>
                                              ...
                                              <td>
                                                <label style="font-size: 15px;" class="label label-primary"><?php if($row['status'] == 1)

                                                    {?>
                                                    <a href="userlist.php?confirm=<?php echo $row['user_no']?>" onclick="return confirm('Do you really want to Un-Confirm the Account')"> <font color="white"> Confirmed <i class="fa fa-check-circle"></i> </font></a> 
                                                    <?php } else {?>
                                                    <a href="userlist.php?unconfirm=<?php echo $row['user_no']?>" onclick="return confirm('Do you really want to Confirm the Account')"> <font color="white"> Un-Confirmed <i class="fa fa-times-circle"></i> </font></a>
                                                    <?php } ?>
                                                  </label>
