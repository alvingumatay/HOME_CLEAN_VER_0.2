       ...
       
		{
		  ...
		  $output .='
             <tr>
                ...
                <td>'.$status.'</td>
                <td>
                    <center><button type="button" name="action" class="btn btn-info btn-xs action"  data-home_id="'.$row["activity"].'"   data-dtime="'.$dtime.'" data-user_no="'.$row["user_no"].'" data-status="'.$row["status"].'" value="" '.$disabled.' >  <span class="fa fa-check"></span> </button>
                     <br/> <br/> 
