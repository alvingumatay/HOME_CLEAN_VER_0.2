   ...
   <!-- Modal content-->  
           <div class="modal-content">  
                ...
                <form method="post" action="login.php" enctype="multipart/form-data">    
                     <center> <input type="email" name="email" style = "width:300px;" class="form-control" placeholder="input your email" />  </center>
                     <br />  
                   
                     <center> <input type="password" name="password"  style = "width:300px;" class="form-control" placeholder="please input your password" />  </center>
                     <br />  
                    <center><button  name="login"  style="width: 300px; height: 40px; background-color: #156699; font-size: 18px;"  "class="btn btn-warning btn-primary">Login</button></center>

                      <hr/>
                     <center>  <button type="button" style="width: 300px; height: 40px; background-color: #156699; font-size: 18px;"  class="btn btn-warning btn-primary" target="_blank" onclick="window.location.href='http://localhost/HCS/public_html/register.php?link=register'">Register</button>
                     </center>
